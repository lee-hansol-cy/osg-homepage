...
import { imgRectangle3 } from "./svg-wz0y9";
...
function ShadowGroup() {
  return (
    <div className="absolute contents left-[410px] top-[930px]" data-name="shadow group">
      ...
      <div className="absolute bg-[rgba(251,225,246,0.8)] blur-[30px] h-[230px] left-[470px] opacity-0 rounded-[160px] top-[990px] w-[1940px]" data-name="reflect shadow" />
    </div>
  );
}
  ...
  return (
    <div className="absolute contents left-[440px] top-[810px]" data-name="body group">
      <div className="absolute h-[300px] left-[440px] pointer-events-none rounded-[160px] top-[810px] w-[2000px]" data-name="button body">
        <div aria-hidden className="absolute bg-gradient-to-b from-[#f02bd1] inset-0 rounded-[160px] to-[#ff81ea]" />
        <div className="absolute inset-0 rounded-[inherit] shadow-[inset_0px_15px_15px_0px_rgba(251,225,246,0.6),inset_0px_-10px_15px_0px_rgba(240,43,209,0.6)]" />
...
export default function BuyItNow() {
  return (
    <div className="bg-white relative size-full" data-name="buy it now 버튼">
      <ButtonGroup />
    </div>
  );
}